          ...
          <div className="row">
            ...
            <div className="col-3">
              ...
              <div className="footer-link d-flex flex-column">
                <Link className="text-white pyg-2 mb-1">Privacy Policy</Link>
                <Link className="text-white pyg-2 mb-1">Refund Policy</Link>
                <Link className="text-white pyg-2 mb-1">Shipping Policy</Link>
                <Link className="text-white pyg-2 mb-1">
                  Terms & Conditions
                </Link>
